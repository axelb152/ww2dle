  ...
  en: {
    translation: {
      ...
      leagues: {
        ...
        inviteFirst:
          "Nobody here yet — send the link and get your league started.",
        spotsLeft: "{{n}} of {{max}} spots left — fill your league!",
        isFull: "Every seat taken. That's a full league.",
        playersLabel: "players",
        percentFull: "{{percent}}% full",
        capacityLabel: "League capacity",
        membersTitle: "League members",
        totalGames: "Games played",
        points: "Total points",
        bestStreak: "Best streak",
        medalsLabel: "Daily podium places",
  ...
  fr: {
    translation: {
      ...
      leagues: {
        ...
        inviteFirst:
          "Personne pour l'instant — envoyez le lien pour lancer votre ligue.",
        spotsLeft: "{{n}} places libres sur {{max}} — complétez votre ligue !",
        isFull: "Toutes les places sont prises. Ligue complète.",
        playersLabel: "joueurs",
        percentFull: "{{percent}} % remplie",
        capacityLabel: "Capacité de la ligue",
        membersTitle: "Membres",
        totalGames: "Parties jouées",
        points: "Points cumulés",
        bestStreak: "Meilleure série",
        medalsLabel: "Podiums quotidiens",
